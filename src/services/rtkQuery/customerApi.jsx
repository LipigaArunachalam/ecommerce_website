...
export const { useCustomerDetailsQuery, useGetCatalogQuery, useGetAllProductsQuery, useUserDashboardQuery,
  ...
  useSearchProductQuery, useGetCategoryQuery, useGetAllCategoryQuery, useEditProfileMutation, useAddAddressMutation,
   useDeleteAddressMutation, useUpdateCartMutation } = customerApi;